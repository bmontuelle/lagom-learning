package fr.hoshi.lagomlearning.api
...
object LagomlearningService  {
  val TOPIC_NAME = "greetings"
}

/**
  * The lagom-learning service interface.
  * <p>
  * This describes everything that Lagom needs to know about how to serve and
  * consume the LagomlearningService.
  */
trait LagomlearningService extends Service {
  ...
  override final def descriptor = {
    import Service._
    // @formatter:off
    named("lagom-learning")
      .withCalls(
        pathCall("/api/hello/:id", hello _),
        pathCall("/api/hello/:id", useGreeting _)
      )
      .withTopics(
        topic(LagomlearningService.TOPIC_NAME, greetingsTopic _)
