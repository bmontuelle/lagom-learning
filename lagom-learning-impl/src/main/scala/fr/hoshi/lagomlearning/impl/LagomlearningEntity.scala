...
/**
  * This is an event sourced entity. It has a state, [[LagomlearningState]], which
  ...
  */
class LagomlearningEntity extends PersistentEntity {

  override type Command = LagomlearningCommand[_]
  override type Event = LagomlearningEvent
  override type State = LagomlearningState

  /**
    * The initial state. This is used if there is no snapshotted state to be found.
    */
  override def initialState: LagomlearningState = LagomlearningState("Hello", LocalDateTime.now.toString)
  ...
  override def behavior: Behavior = {
    case LagomlearningState(message, _) => Actions().onCommand[UseGreetingMessage, Done] {
      ...
      case (GreetingMessageChanged(newMessage), state) =>
        ...
        // the event.
        LagomlearningState(newMessage, LocalDateTime.now().toString)
...
/**
  ...
  */
case class LagomlearningState(message: String, timestamp: String)

object LagomlearningState {
  /**
    ...
    */
  implicit val format: Format[LagomlearningState] = Json.format
}

/**
  * This interface defines all the events that the LagomlearningEntity supports.
  */
sealed trait LagomlearningEvent extends AggregateEvent[LagomlearningEvent] {
  def aggregateTag = LagomlearningEvent.Tag
}

object LagomlearningEvent {
  val Tag = AggregateEventTag[LagomlearningEvent]
}

/**
  * An event that represents a change in greeting message.
  */
case class GreetingMessageChanged(message: String) extends LagomlearningEvent
...
/**
  ...
  */
sealed trait LagomlearningCommand[R] extends ReplyType[R]
...
/**
  ...
  */
case class UseGreetingMessage(message: String) extends LagomlearningCommand[Done]
...
/**
  ...
  * person.
  */
case class Hello(name: String) extends LagomlearningCommand[String]
...
/**
  ...
  * application loader.
  */
/*** Defined in the  application loader for now
